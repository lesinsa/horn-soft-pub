...
public final class ArquillianHelper {
    ...
    public static File[] getCommonLibs() {
        ...
        return Maven.resolver()
                .resolve("ru.prbb.commons:common-config:" + version, "ru.prbb.commons:common-jee:" + version)
                .withoutTransitivity()
                .asFile();
    }
    ...
    public static File[] getSecurityLib() {
        String version = getProjectVersion();
        return Maven.resolver()
                .resolve("ru.prbb.commons:auth:" + version)
                .withoutTransitivity()
                .asFile();
    }
    ...
    public static File[] getCommonLib(String name) {
        String version = getProjectVersion();
        return Maven.resolver()
                .resolve(String.format("ru.prbb.commons:%s:%s", name, version))
                .withTransitivity()
                .asFile();
    }
