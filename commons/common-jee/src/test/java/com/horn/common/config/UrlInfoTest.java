...
public class UrlInfoTest {
    ...
    private static final String TEST_LOCATION_1 = "datasource:" + DATASOURCE_NAME + "?ns=com.horn.mobile&tableName=mAppConfig";
    ...
    public void test1() throws Exception {
        ...
        assertEquals("com.horn.mobile", sut.getProperty("ns"));
    ...
    public void test5() throws Exception {
        UrlInfo sut = new UrlInfo(TEST_LOCATION_3 + "table_name=Таблица1&ns=com.horn.mobile");
        assertEquals("datasource", sut.getProtocol());
        assertEquals("jdbc/ureb", sut.getResourceName());
        assertEquals(2, sut.getProperties().size());
    ...
    public void test6() throws Exception {
        UrlInfo sut = new UrlInfo(TEST_LOCATION_4 + "table_name=Таблица1&ns=com.horn.mobile");
        assertEquals("datasource", sut.getProtocol());
        assertEquals("jdbc/ureb", sut.getResourceName());
        assertEquals(2, sut.getProperties().size());
        assertEquals("Таблица1", sut.getProperty("table_name"));
