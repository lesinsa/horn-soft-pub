...
import com.horn.common.config.ConfigBeanPostProcessor;
...
public class CommonConfigIT {
    public static final String DEF_NS = "com.horn.common.soap-config";
    ...
    public static Archive<?> deploy() {
        return ShrinkWrap.create(JavaArchive.class, "commonjee.jar")
                ...
                .addPackage("com.horn.common.config")
    ...
    public void setUp() throws Exception {
        ...
        try {
            ...
            try (Connection connection = dataSource.getConnection()) {
                ...
                insertRow(stmt, "com.horn.legacy", "param1", "Hi!");
            }
            init = true;
        } catch (Exception e) {
