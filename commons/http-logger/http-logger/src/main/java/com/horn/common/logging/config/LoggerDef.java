...
public class LoggerDef {
    ...
    @XmlAttribute(name = "custom-config-impl")
    private String customConfiguratorClass;
    ...
    public String getCustomConfiguratorClass() {
        return customConfiguratorClass;
    }

    public void setCustomConfiguratorClass(String customConfiguratorClass) {
        this.customConfiguratorClass = customConfiguratorClass;
    }
